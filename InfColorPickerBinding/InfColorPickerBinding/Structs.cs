...
namespace InfColorPicker
{
	static class CFunctions
	{
		...
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		static extern unsafe IntPtr createSaturationBrightnessSquareContentImageWithHue(float hue);

		// extern CGImageRef createHSVBarContentImage (InfComponentIndex barComponentIndex, float *hsv);
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		static extern unsafe IntPtr createHSVBarContentImage(InfComponentIndex barComponentIndex, float[] hsv);
	}
